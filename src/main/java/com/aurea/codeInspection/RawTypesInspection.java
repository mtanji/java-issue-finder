...
public class RawTypesInspection extends AbstractBaseJavaLocalInspectionTool {
    ...
    static class RawTypesVisitor extends JavaElementVisitor {
        ...
        @NonNls
        private final String DESCRIPTION_TEMPLATE = TrilogyBundle.message("inspection.trilogy.raw.types.problem.description");
        ...
        @Nullable
        private PsiType getSuggestedType(@NotNull PsiVariable variable) {
